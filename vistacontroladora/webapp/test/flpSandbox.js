		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#vistacontroladoravistacontroladora-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vistacontroladoravistacontroladora-display": {
								"semanticObject": "vistacontroladoravistacontroladora",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vistacontroladora.vistacontroladora",
									"url": sap.ui.require.toUrl("vistacontroladora/vistacontroladora")
								}
							}
						}
					}
