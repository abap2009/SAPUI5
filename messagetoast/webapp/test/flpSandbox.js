		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#messagetoastmessagetoast-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"messagetoastmessagetoast-display": {
								"semanticObject": "messagetoastmessagetoast",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=messagetoast.messagetoast",
									"url": sap.ui.require.toUrl("messagetoast/messagetoast")
								}
							}
						}
					}
