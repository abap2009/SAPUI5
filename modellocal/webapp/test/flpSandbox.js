		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title modellocal",
									"targetURL": "#modellocalmodellocal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"modellocalmodellocal-display": {
								"semanticObject": "modellocalmodellocal",
								"action": "display",
								"description": "A Fiori application modellocal",
								"title": "App Title modellocal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=modellocal.modellocal",
									"url": sap.ui.require.toUrl("modellocal/modellocal")
								}
							}
						}
					}
